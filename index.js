...
class Person{
  ...
  eat(food){
    if(this.stomach.length>9){
      return `${this.name} is full, Please poop`;
    }
...
// const pabloPerson = new Person({
//    name:'Pablo',
//    age:35,
// });

// pabloPerson.eat("uhhhh here");
// console.log(pabloPerson.watEAT());
// console.log(pabloPerson);
// console.log(pabloPerson.toString());
// console.log(pabloPerson);
...
class Car {
  ...
  fill(gallons){
    this.tank+=gallons;
    return `${gallons} have been added to Tank`;
  }
  drive(miles){
